...
class Factory {
  constructor(make, location, airbags, abs, warranty, massBuild, customerBuild) {
    this.make = "Mazda";
    this.location = "USA";
    this.airbags = true;
    this.abs = true;
...
class Sport extends Car {
  constructor(model, doors, color, trim, enginetype, transmission, wheelstrim, audio, seatstrim, moonroof, top, convertible) {
    super();
    this.model = model;
    this.doors = 2;
    this.color = color;
...
class Truck extends Factory {
  constructor(model, color, enginesize, hitch, bed, navigation, warranty, backupcamera, audio, doors, trim){
    super();
    this.model = model;
    this.color = color;
...
console.log("mass build:", mazda3.massBuild(35000));
...
console.log("customer build:", mazda3.customerBuild("yellow", ["weather package", " satellite radio", " rear spoiler"]));
...
let miataRf = new Sport("Miata-RF", 2, "red", "Grand Touring", "gasoline", "manual", "premium", "premium", "leather", false, "hard top", true);
...
console.log("mass build:", miataRf.massBuild(15000));
...
console.log("customer build:", miataRf.customerBuild("black", ["hid headlights"," sports suspension"," leather steering wheel"," heated seats"," adaptive cruise control"]));
...
let trailBlazer = new Truck("Trail Blazer", "blue", 8, true, "standard", true, "120,000 / 6 years", true, "basic", 2, "sport");
...
console.log("mass build:", trailBlazer.massBuild(35000));
...
console.log("customer build:", trailBlazer.customerBuild("red", [" seat warmers"," tinted windows"," fog lamps"]));
